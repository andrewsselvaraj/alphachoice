...
<?php
$result = mysql_query("SELECT * FROM product_info pi ,supplier_info si , product_supplier ps where pi.pk_product_id = ps.fk_product_id and si.pk_supplier_id = ps.fk_supplier_id");
 $i=0;
...
?>
    ...
    <div class="section group">
					...
					<form action="pc_enquiryEntry.php" method="post">
												 						 ...
												 						 <a href="uploads/<?php echo"$product_image" ?>" class="swipebox" title="Image Title"> <img src="uploads/<?php echo"$product_image" ?>" alt="" width="150" height="150"><span class="zoom-icon"></span> </a>
						...
						<!--<a href="#" class="link">Read More</a>-->
						 ...
						 <input type="hidden" name=supplier_name value="<?php echo "$supplier_name" ?>">
						  <input type="hidden" name=product_detail value="<?php echo "$product_detail" ?>">
						   		...
						   		<span><input type="submit" value="Send Enquiry"></span>
								</form>
