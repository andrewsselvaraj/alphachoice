...
$sql="Delete from supplier_info where pk_supplier_id= '$supplier_id'";
 //$sql="UPDATE supplier_info SET pk_supplier_id='$supplier_id', supplier_name='$supplier_name', supplier_type='$supplier_type', supplier_detail='$supplier_detail', website='$website', created_by='$created_by', created_date='$created_date', status='$status' WHERE pk_supplier_id='$supplier_id'";
