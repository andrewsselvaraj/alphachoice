...
$sql="UPDATE supplier_info SET  supplier_name='$supplier_name', supplier_type='$supplier_type', supplier_detail='$supplier_detail', website='$website', created_by='$created_by', created_date='$created_date', status='$status' WHERE pk_supplier_id='$supplier_id'";
