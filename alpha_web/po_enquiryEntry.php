					...
					?>
					    <form method="post" enctype="multipart/form-data" action="pc_enquiryEntryProcess.php" method="post">
					    	...
					    	<div>
						    	...
						    	<span><INPUT  type="text" size="20" readonly="readonly" maxlength="50" id="supplier_id" name="supplier_name" value="<?php echo "$supplier_name" ?>"> </span>
						    </div>	
							
												    	<div>
						    	<span><label>Product ID </label></span>
						    	<span><INPUT  type="text" size="20" readonly="readonly" maxlength="50" id="product_id" name="product_id" value="<?php echo "$product_id" ?>"> </span>
						    </div>
					    	<div>
						    	<span><label>Product Name </label></span>
						    	<span><INPUT  type="text" size="20" readonly="readonly" maxlength="50" id="product_name" name="product_name" value="<?php echo "$product_name" ?>"> </span>
						    </div>
							...
							<div>
						    	...
						    	<span><INPUT  type="text" size="20" maxlength="50" id="email" name="email" > </span>
						    </div>
