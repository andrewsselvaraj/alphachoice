...
$sql="INSERT INTO `product_order` (`pk_order_id`,`customer_name`, `email_id`, `mobile`, `address`,`city`,`state`,`pincode`,`country`,`message`, `created_by`, `created_date`, `last_updated_by`, `last_updated_datetime`, `status`) VALUES ('$transaction_id', '$customer_name', '$email_id', '$mobile','$address','$city','$state','$pincode','$country', '$message', '-', 'now()', '-', 'now()', 'A')";
//$fax= $_POST['fax'];
//$email= $_POST['email'];
