...
$sql="INSERT INTO `product_catalog`.`product_enquiry` (`pk_product_supplier_id`,`fk_product_id`,`fk_supplier_id`,  `customer_id`, `customer_name`, `email_id`, `mobile`, `message`, `created_by`, `created_date`, `last_updated_by`, `last_updated_datetime`, `status`) VALUES ('$pk_product_supplier_id','$product_id','$supplier_id', '$customer_id' , '$customer_name', '$email_id', '$mobile', '$message', '$customer_id', 'now()', '$customer_id', 'now()', 'A')";
//$fax= $_POST['fax'];
//$email= $_POST['email'];
