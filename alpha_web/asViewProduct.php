...
while($row = mysql_fetch_array($result))
  {
  echo "<tr>";
  echo "<td><span class=disp>" . $row['pk_product_id'] . "</span></td>";

  echo "<td><span class=disp><a href='asEditProduct.php?product_id=" . $row['pk_product_id'] . "'>" . $row['pk_product_id'] . "</a></span></td>";
