...
<form action="asUpdateProduct.php" method="post">
...
$sql = "select * from product_info where pk_product_id='$product_id'";
...
//$id = $row['id']; 
$id = $id +1;
$product_id = $row['pk_product_id']; //use a ' instead of " 
...
<tr >
                                        <td align=right><span class=caption><input Type=submit name=Submit value=Update class="plain"></span></td>
